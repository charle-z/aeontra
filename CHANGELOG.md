...
- Use a digest-pinned Wolfi runtime with patched zlib and PCRE2 packages for the
  main container image; retain the High-severity Grype gate without a VEX exemption.
