...
into observability. An unknown session can indicate a prior instance, expiry, revocation,
or invalid input; the server does not claim a stale client catalog unless external
