...
| Brain memory | In progress | P9 branch `p9-brain`: specs/ADR active; Markdown/frontmatter truth, curated/working trust, pure-Go SQLite FTS5 disposable cache, five bounded tools, and no resident service. |
