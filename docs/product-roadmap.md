...
| 4 persistent universal toolbox | Core/services deployed; final source candidate pending | PRs #128/#129 deployed lifecycle and services. The current candidate adds verified CPU/memory/process limits, storage usage and access to the validated rootless engine for installed Podman/Docker/Compose clients. BuildKit/Compose acceptance, publication, signed release and real restart proof remain. |
