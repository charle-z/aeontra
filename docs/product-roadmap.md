...
| 4 persistent universal toolbox | Source candidate complete; publication and device acceptance pending | One persistent rootless Debian rootfs per workspace now has create/status/arbitrary exec/install/repair, named service start/status/stop and explicit cleanup. PR, deployment, signed release and real restart acceptance remain. |
