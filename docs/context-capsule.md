...
concurrency, and curated policy/protocol/state fuzz seeds are complete. The race
command remains honestly blocked by `CGO_ENABLED=0` in the production builder and must
run in P6. Next are package-specific coverage and hermetic integration evidence. P5
