...
3. Design the Edge identity/pairing and leased-task protocol test-first. Do not expose
   a remote shell, pair a real device, or install WSL components automatically.
