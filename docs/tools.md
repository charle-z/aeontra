...
| `project_task_status` | 1/0/1/0 | Reconcile and return bounded task/worker lifecycle, branch and opaque worktree/workspace/runtime identities without exposing prompts, leases, fences, paths, credentials or process internals. |
