...
func TestRegisterAnnotationsDefinesStableSecurityPostures(t *testing.T) {
	...
	want := []capturedAnnotation{
		...
		{Hints: externalDestructive, Names: []string{"run_command", "run_tests", "source_pull_request_merge", "source_default_branch_update", "coolify_deploy", "platform_deploy", "platform_deploy_without_cache", "coolify_set_env", "privileged_task_execute", "project_validation_execute"}},
