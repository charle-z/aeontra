...
func TestRegisterAnnotationsDefinesStableSecurityPostures(t *testing.T) {
	...
	want := []capturedAnnotation{
		...
		{Hints: externalRead, Names: []string{"github_repo_info", "source_repo_info", "source_repo_create_preview", "source_pull_request_create_preview", "source_pull_request_status", "source_pull_request_failure_diagnostics", "source_pull_request_job_log", "source_pull_request_merge_preview", "source_default_branch_update_preview", "source_workflow_dispatch_preview", "repo_publish_preview", "coolify_list_apps", "platform_apps_list", "coolify_app_status", "platform_app_status", "coolify_app_logs", "platform_app_logs", "coolify_deployment_status", "platform_deployment_status", "platform_app_create_preview", "platform_validation_runner_create_preview", "platform_front_door_create_preview", "platform_front_door_status", "platform_deploy_preview", "platform_deploy_without_cache_preview"}},
		{Hints: localWrite, Names: []string{"create_file", "git_commit", "brain_write"}},
		{Hints: externalWrite, Names: []string{"git_clone", "git_push", "repo_publish", "github_create_repo", "source_repo_create", "source_pull_request_create", "coolify_create_app", "platform_app_create", "platform_validation_runner_create"}},
		...
		{Hints: externalDestructive, Names: []string{"run_command", "run_tests", "source_pull_request_merge", "source_default_branch_update", "source_workflow_dispatch", "coolify_deploy", "platform_deploy", "platform_deploy_without_cache", "coolify_set_env", "platform_front_door_create", "privileged_task_execute", "project_validation_execute"}},
