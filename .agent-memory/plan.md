...
5. [done] Remove temporary diagnostics and helpers. Complete formatting, focused commands, full serial tests, docs, vet, build and diff check locally.
6. [active] Publish validation SHA `d3d57668504e1d38edfee7baf9f18379e37f205f` and require a new exact-SHA distributed E2E with direct normal/restart, remote normal/restart, repository modification, four completed tools, request_ref, tests, completion and zero duplicates.
