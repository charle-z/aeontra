...
export default function App() {
  ...
  const content = (() => {
    switch (active) {
      ...
      case "Security": return <HonestUnavailable title="Security Posture" rows={[["Console authority", status?.surface ?? "presentation-only", "Server-declared console authority boundary."], ["Query-key auth", "Removed", "Credentials in URL query parameters always return 401; OAuth or Authorization bearer is required."], ["Free shell", "Absent", "The browser cannot invoke MCP tools or arbitrary commands."]]} />;
