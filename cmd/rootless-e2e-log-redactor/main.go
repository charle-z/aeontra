...
func category(line string) string {
	...
	checks := []struct {
		...
		{"rootless command failed: exit status 41 output=", "workspace_fixture_missing"},
		{"rootless command failed: exit status 42 output=", "workspace_bind_writable"},
		{"rootless command failed: exit status 125 output=", "engine_command"},
		{"rootless command failed: exit status 126 output=", "container_command_unexecutable"},
		{"rootless command failed: exit status 127 output=", "container_command_not_found"},
